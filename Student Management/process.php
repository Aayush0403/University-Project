...
if($_SERVER['REQUEST_METHOD']=='POST')
{
   ...
   $branch=$_POST['branch'];
    ...
    if((!empty($name)and !empty($mail) and !empty($pswd)))
    {
        ...
        {
            mysqli_query($dbc,"INSERT INTO forms(NAME,DOB,REGISTRATIONNO,EMAIL,MOBILENO,GENDER,HOBBIES,BRANCH,PASSWORD) VALUES('$name','$dob','$reg','$mail','$cbl','$gender','$hobbies','$branch','$pswd')");
        }
